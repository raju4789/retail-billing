...
class DataLoadListener implements ApplicationListener<ApplicationReadyEvent> {
	...
	public void onApplicationEvent(ApplicationReadyEvent event) {
		...
		try {
			...
			new User("08b9009d-9669-4e8b-85fe-4be50f5b6ec9", "Ram", "AFFLIATE", accountCreatedOn);
			userRepository.save(user);
			...
			product = new Product("9cbe56f3-cf7f-4c4a-a3ea-ba8e26f3593b", "cake", "", productCategory, 20.04);
			productRepository.save(product);
			
			product = new Product("5b0efc30-9d99-4352-94b5-0b71e2f85abe", "oil", "", productCategory, 100.04);
			productRepository.save(product);
			...
			product = new Product("69715815-4775-445e-b7d1-6f86862018c9", "MI smart watch", "", "ELECTRONICS", 6800);
			productRepository.save(product);
			
			product = new Product("69715815-4775-445e-b7d1-6f86862018c9", "red t shirt", "", "ELECTRONICS", 6800);
			productRepository.save(product);
			
			product = new Product("6971581o-4775-445e-b7d1-6f86862018c9", "black shoes", "", "ELECTRONICS", 6800);
			productRepository.save(product);
